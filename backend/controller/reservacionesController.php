...
if (filter_input(INPUT_POST, 'action') != null) {
    ...
    try {
        ...
        if ($action === "add_reservaciones" or $action === "update_reservaciones") {
            ...
            if ((filter_input(INPUT_POST, 'idreservaciones') != null) && (filter_input(INPUT_POST, 'usuario_idusuario') != null) && (filter_input(INPUT_POST, 'vuelos_idvuelos') != null) && (filter_input(INPUT_POST, 'fecha_reservacion') != null) && (filter_input(INPUT_POST, 'numero_fila') != null) && (filter_input(INPUT_POST, 'numero_asiento') != null)) {
                $myReservaciones->setidreservaciones(filter_input(INPUT_POST, 'idreservaciones'));
                $myReservaciones->setusuario_idusuario(filter_input(INPUT_POST, 'usuario_idusuario'));
                $myReservaciones->setvuelos_idvuelos(filter_input(INPUT_POST, 'vuelos_idvuelos'));
                ...
                $myReservaciones->setLastUser('112540148');
                $myReservaciones->setLastUser('112540148');
        ...
        if ($action === "show_reservaciones") {//accion de mostrar cliente por ID
            //se valida que los parametros hayan sido enviados por post
            if (filter_input(INPUT_POST, 'idreservaciones') != null) {
                $myReservaciones->setidreservaciones(filter_input(INPUT_POST, 'ididreservaciones'));
