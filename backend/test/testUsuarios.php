...
$obj_usuario->setidusuario(5678);
$obj_usuario->setContraseña("1234");
$obj_usuario->setFecha_registro("20201121");
$obj_usuario->setFecha_actualizacion("20201121");
$obj_usuario->setPersonas_idpersonas(100010001);
